...
<head>
    ...
    <title>Edit Blog Tag | IslamicPrayerTimes</title>
...
<body>
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <h2 class="mb-4">Edit Blog Tag</h2>
                    </div>
                </div>
                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.blog-tags.update', $blogTag->id) }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="tagName" name="name" value="{{ old('name', $blogTag->name) }}" required>
                                    </div>
                                    
                                    <div class="mb-3">
                                        <label for="tagSlug" class="form-label">Slug</label>
                                        <input type="text" class="form-control" id="tagSlug" name="slug" value="{{ old('slug', $blogTag->slug) }}">
                                        <div class="form-text">URL-friendly version of the name.</div>
                                    </div>
                                    
                                    <div class="mb-3">
                                        <label for="tagDescription" class="form-label">Description</label>
                                        <textarea class="form-control" id="tagDescription" name="description" rows="4">{{ old('description', $blogTag->description) }}</textarea>
                                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <span class="badge bg-primary float-end">{{ $blogTag->blogs_count }}</span>
                                </div>
                                <div class="mb-3">
                                    <strong>Created:</strong>
                                    <span class="float-end">{{ $blogTag->created_at->format('M d, Y') }}</span>
                                </div>
                                <div class="mb-3">
                                    <strong>Last Updated:</strong>
                                    <span class="float-end">{{ $blogTag->updated_at->format('M d, Y') }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body">
                                <div class="tag-cloud">
                                    <span class="badge bg-primary mb-2">quran</span>
                                    <span class="badge bg-primary mb-2">prayer</span>
                                    <span class="badge bg-primary mb-2">ramadan</span>
                                    <span class="badge bg-primary mb-2">fasting</span>
                                    <span class="badge bg-primary mb-2">charity</span>
                                    <span class="badge bg-primary mb-2">patience</span>
                                    <span class="badge bg-primary mb-2">family</span>
                                    <span class="badge bg-primary mb-2">spirituality</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Once you delete a tag, there is no going back. Please be certain.</p>
                                <form action="{{ route('admin.blog-tags.destroy', $blogTag->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-danger w-100" onclick="return confirm('Are you sure you want to delete this tag? This action cannot be undone.')">
    ...
    <script>
        ...
        document.getElementById('tagName').addEventListener('input', function() {
            ...
            if (!slugField.value || slugField.value === '{{ $blogTag->slug }}') {
