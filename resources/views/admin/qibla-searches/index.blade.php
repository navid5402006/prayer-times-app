...
<head>
    ...
    <title>Qibla Direction Management | IslamicPrayerTimes</title>
...
<body>
    ...
    <div class="main-container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="mb-0">Qibla Direction Cities</h2>
            <div>
        ...
        <div class="card" style=" width: 80%; margin-left: 200px; ">
            <div class="card-header d-flex justify-content-between align-items-center">
                <span><i class="fas fa-compass me-2"></i> All Qibla Searches</span>
                    ...
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            @forelse($searches as $row)
                                @php
                                    // Check if updated_at is different from created_at (within a few seconds margin)
                                    // If updated_at > created_at + 10 seconds, it means manually updated
                                    $isManuallyUpdated = false;
                                    if ($row->created_at && $row->updated_at) {
                                        // If updated_at is more than 10 seconds after created_at, it was manually updated
                                ...
                                <tr>
                                    ...
                                    <td>{{ $row->country }}</td>
                                    <td>
                                        <span class="badge bg-info text-dark px-3 py-2">{{ $row->qibla_direction }}°</span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <a href="{{ route('admin.qibla-searches.edit', $row->id) }}"
                            ...
                            @empty
                                <tr>
                                    <td colspan="9" class="text-center py-5">
                                        ...
                                        <p class="text-muted fs-5">No qibla searches found</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
    ...
    <script>
        ...
        function confirmDelete(id, cityName) {
            ...
            // Set form action URL
            document.getElementById('deleteForm').action = baseUrl + '/admin/qibla-searches/' + id;
