...
<head>
    ...
    <title>Add Blog Category | IslamicPrayerTimes</title>
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.blog-categories.store') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="categorySlug" name="slug" value="{{ old('slug') }}">
                                        <div class="form-text">URL-friendly version of the name. Leave blank to auto-generate.</div>
                                    </div>
                                    
                                    <div class="mb-3">
                                        <label for="categoryDescription" class="form-label">Description</label>
                                        <textarea class="form-control" id="categoryDescription" name="description" rows="4">{{ old('description') }}</textarea>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="alert alert-info">
                                    ...
                                    <strong>About Categories</strong>
                                    <p class="mb-0 mt-2">Categories help organize your blog content. Each blog post can be assigned to one category.</p>
                                </div>
                                ...
                                <div class="mt-3">
                                    ...
                                    <ul class="ps-3">
                                        ...
                                        <li>Inactive categories won't be shown</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
