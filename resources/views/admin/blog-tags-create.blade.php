...
<head>
    ...
    <title>Add Blog Tag | IslamicPrayerTimes</title>
    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <h2 class="mb-4">Add New Blog Tag</h2>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.blog-tags.store') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="tagName" name="name" value="{{ old('name') }}" required>
                                    </div>
                                    
                                    <div class="mb-3">
                                        <label for="tagSlug" class="form-label">Slug</label>
                                        <input type="text" class="form-control" id="tagSlug" name="slug" value="{{ old('slug') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="tagDescription" name="description" rows="4">{{ old('description') }}</textarea>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="alert alert-info">
                                    ...
                                    <strong>About Tags</strong>
                                    <p class="mb-0 mt-2">Tags help organize your blog content with specific keywords. Each blog post can be assigned multiple tags.</p>
                                </div>
                                ...
                                <div class="mt-3">
                                    ...
                                    <ul class="ps-3">
                                        ...
                                        <li>Keep tags focused and descriptive</li>
                                        <li>A post can have multiple tags</li>
                                        <li>Use tags to connect related content</li>
                                        <li>Inactive tags won't be shown</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
